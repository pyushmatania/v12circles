...
const Hero: React.FC<HeroProps> = memo(({ setCurrentView }) => {
  ...
  // 🚀 Memoized particle dots for better performance
  ...
  return (
    ...
    >
      ...
      {/* 🚀 Enhanced Multi-Color Burst Orbs - Optimized Performance */}
      <div className="absolute inset-0 overflow-hidden transform-gpu will-change-transform">
        ...
        {/* Tertiary Burst Orb */}
        <div 
          className={`absolute top-1/2 right-1/3 w-[20rem] h-[20rem] rounded-full blur-3xl opacity-40 transition-all duration-[3000ms] ${currentGradientConfig.tertiary}`}
          style={{
        ...
        <div 
          className={`absolute top-1/3 left-1/3 w-[16rem] h-[16rem] rounded-full blur-3xl opacity-35 transition-all duration-[3000ms] ${currentGradientConfig.quaternary}`}
          style={{
        ...
        <div 
          className={`absolute top-1/6 right-1/6 w-[12rem] h-[12rem] rounded-full blur-2xl opacity-30 transition-all duration-[3000ms] ${currentGradientConfig.floating1}`}
          style={{
        ...
        <div 
          className={`absolute bottom-1/6 left-1/6 w-[14rem] h-[14rem] rounded-full blur-2xl opacity-25 transition-all duration-[3000ms] ${currentGradientConfig.floating2}`}
          style={{
